...
class US_Company_Bankruptcy_Data:
    """
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            print("Collections in DB:", self.mongo_client.database.list_collection_names())
    ...
    def export_collection_as_dataframe(self, collection_name: str, database_name: Optional[str] = None) -> pd.DataFrame:
        ...
        try:
            ...
            if database_name is None:
                ...
                count = self.mongo_client.database[collection_name].count_documents({})
                print(f"Documents in {collection_name}: {count}")
                doc = self.mongo_client.database[collection_name].find_one()
                print(doc)
            else:
